...
export default function ConsultationsList({ consultationData,getStatusColor,getStatusIcon,formatDate,truncateText,setSelectedConsultation }) {
  return(
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-green-900">
              {consultationData.filter((c) => c.status === "completed").length}
            </p>
          </div>
